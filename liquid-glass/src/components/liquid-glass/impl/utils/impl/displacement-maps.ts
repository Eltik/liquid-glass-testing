...
const generateDisplacementMap = (type: "standard" | "polar" | "prominent", width = 256, height = 256): string => {
...
const getDisplacementMapLazy = () => Promise.resolve(generateDisplacementMap("standard"));
const getPolarDisplacementMapLazy = () => Promise.resolve(generateDisplacementMap("polar"));
const getProminentDisplacementMapLazy = () => Promise.resolve(generateDisplacementMap("prominent"));

export { generateDisplacementMap, getDisplacementMap, getPolarDisplacementMap, getProminentDisplacementMap, getDisplacementMapLazy, getPolarDisplacementMapLazy, getProminentDisplacementMapLazy, fragmentShaders, displacementCache };
