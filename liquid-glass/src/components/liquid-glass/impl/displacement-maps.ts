...
// Convenience functions for specific displacement map types
...
export const getProminentDisplacementMap = () =>
  generateDisplacementMap("prominent");

// Lazy-loading versions that return promises
const getDisplacementMapLazy = () => {
  return new Promise<string>((resolve) => {
    resolve(generateDisplacementMap("standard"));
  });
};

const getPolarDisplacementMapLazy = () => {
  return new Promise<string>((resolve) => {
    resolve(generateDisplacementMap("polar"));
  });
};

const getProminentDisplacementMapLazy = () => {
  return new Promise<string>((resolve) => {
    resolve(generateDisplacementMap("prominent"));
  });
};
