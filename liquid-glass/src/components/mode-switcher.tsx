...
export default function ModeSwitcher({ onModeChange, currentMode }: ModeSwitcherProps) {
    return (
        <div className="fixed top-20 right-4 z-[10001] rounded-lg bg-black/50 p-4 text-white backdrop-blur-sm">
            ...
            <div className="space-y-2">
                <label className="flex cursor-pointer items-center space-x-2">
                    <input type="radio" name="mode" value="original" checked={currentMode === "original"} onChange={() => onModeChange("original")} className="h-4 w-4 accent-blue-500" />
                    <span className="text-sm">Original</span>
                </label>
                <label className="flex cursor-pointer items-center space-x-2">
                    <input type="radio" name="mode" value="enhanced" checked={currentMode === "enhanced"} onChange={() => onModeChange("enhanced")} className="h-4 w-4 accent-blue-500" />
